...
Route::group(['namespace' => 'Inspirium\TaskManagement\Controllers\Api', 'middleware' => ['api', 'auth:api'], 'prefix' => 'api'], function() {
	...
	Route::group(['prefix' => 'tasks'], function() {
		...
		Route::post('rejectOrder', 'DepartmentController@rejectOrder');
		...
		Route::post('employee/{employee}/{type}', 'EmployeeController@employeeTasks');
	...
	Route::group(['prefix' => 'task'], function() {
		...
		Route::post('{id}/resend', 'TaskController@resendTask');
